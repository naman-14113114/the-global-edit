...
export default function NotFound() {
  return (
    <div className="flex min-h-[62vh] items-center bg-[#f7f7f5]">
      <div className="mx-auto w-full max-w-3xl px-4 py-16 text-center md:px-8">
        ...
        <Link
          href="/guides"
          className="mt-8 inline-flex min-h-12 items-center justify-center gap-2 bg-stone-950 px-6 py-3 text-xs font-bold uppercase tracking-[0.14em] text-white"
        >
